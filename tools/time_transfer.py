...
def main():
    ...
    parser.add_argument('-m', '--mode', choices=['to_date', 'to_timestamp'], help='Conversion mode: to_date or to_timestamp')
    parser.add_argument('-v', '--value', help='The timestamp or date string to convert')
    parser.add_argument('-t', '--timezone', choices=TIME_ZONES.keys(), help='Timezone: 1 for Shanghai, 2 for Los Angeles, 3 for Beijing')
